...
public class QRCodeUtil {
    ...
    public static void encode(String content, String imgPath, String destPath, boolean needCompress, String paperId, String bottomContent) throws Exception {
        BufferedImage image = QRCodeUtil.createImage(content, imgPath,
                needCompress);
...
//        String text = "http://www.baidu.com/";// 二维码的链接地址
//        String text = "我想你了宝";// 二维码的内容
